...
public class UnitInfoVo {
	private Integer unitInfoId;// 单位id
	// 单位基本情况
	...
	public String toString() {
		return "UnitInfoVo [unitInfoId=" + unitInfoId + ", baseInfoId=" + baseInfoId + ", unitName=" + unitName
				+ ", unitAbbreviation=" + unitAbbreviation + ", establishmentDate=" + establishmentDate
				...
				+ ", developerNumber=" + developerNumber + ", juniorNumber=" + juniorNumber + ", intermediateNumber="
