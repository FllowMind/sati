...
public class AgencyInfoVo {
	...
	private String classicCase;// 经典案例

	// 单位基本信息
	private Integer unitBaseinfoId;
	...
	public Integer getUnitBaseinfoId() {
		return unitBaseinfoId;
	}

	public void setUnitBaseinfoId(Integer unitBaseinfoId) {
		this.unitBaseinfoId = unitBaseinfoId;
	}
	...
	public Integer getIntermediateNunber() {
		return intermediateNunber;
	}

	public void setIntermediateNunber(Integer intermediateNunber) {
		this.intermediateNunber = intermediateNunber;
	}
	...
	public String toString() {
		return "AgencyInfoVo [agencyId=" + agencyId + ", unitNature=" + unitNature + ", classicCase=" + classicCase
				+ ", unitBaseinfoId=" + unitBaseinfoId + ", unitName=" + unitName + ", unitAbbreviation="
				+ unitAbbreviation + ", establishmentDate=" + establishmentDate + ", legalRepresentative="
				+ legalRepresentative + ", unitAddress=" + unitAddress + ", locationId=" + locationId + ", key=" + key
				+ ", unitCodeType=" + unitCodeType + ", unitCode=" + unitCode + ", unitCodeImageUrl=" + unitCodeImageUrl
				+ ", unitProfile=" + unitProfile + ", businessField=" + businessField + ", remark=" + remark
				...
				+ qqormsnNumer + ", phoneNumber=" + phoneNumber + ", soeId=" + soeId + ", totalNumber=" + totalNumber
				+ ", developerNumber=" + developerNumber + ", juniorNumber=" + juniorNumber + ", intermediateNunber="
				+ intermediateNunber + ", seniorNumber=" + seniorNumber + ", juniorCollegeNumber=" + juniorCollegeNumber
